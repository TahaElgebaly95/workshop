    ...
    return  Container(padding: EdgeInsets.all(12),
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(data.numOfPt??'',style: TextStyle(color: Color(0xffF14985))),
          ...
          Text(data.numOfSteps??'',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25),),
          SizedBox(width: 5,),
